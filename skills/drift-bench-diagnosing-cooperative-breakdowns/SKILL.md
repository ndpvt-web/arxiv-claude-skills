...
**Paper:** [2602.02455v1](https://arxiv.org/abs/2602.02455v1) | **Category:** cs.AI | **Published:** 2026-02-02
**Authors:** Han Bao, Zheyuan Zhang, Pengcheng Jing, Zhengqing Yuan, Kaiwen Shi
...
1. **Understand the problem context** -- The paper addresses as large language models transition to autonomous agents, user inputs frequently violate cooperative assumptions (e.g., implicit intent, missing parameters, false presuppositions, or ambiguous expressions), creating execution risks that text-only ...
...
Refer to the [full paper](https://arxiv.org/abs/2602.02455v1) for detailed methodology, experimental results, and ablation studies.