...
**Paper:** [2602.00238v1](https://arxiv.org/abs/2602.00238v1) | **Category:** cs.CL | **Published:** 2026-01-30
...
- Proposes: novel metrics tailored to evaluating the diversity-quality trade-off in open-ended questions
- Novel: reflection-guided generation and memory-augmented iterative refinement,
- Novel: metrics tailored
- Achieves: the best diversity-quality trade-off compared to competitive baselines and previous state-of-the-art methods on the real-world infinity-chat dataset
...
1. **Understand the problem context** -- The paper addresses existing retrieval-augmented generation (rag) systems are primarily designed under the assumption that each query has a single correct answer.
...
Refer to the [full paper](https://arxiv.org/abs/2602.00238v1) for detailed methodology, experimental results, and ablation studies.